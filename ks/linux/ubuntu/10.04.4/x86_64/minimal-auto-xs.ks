...
(
echo  'Acquire::http::proxy "http://192.168.11.8:3142/";' > /etc/apt/apt.conf.d/00proxy
cat <<'EOP'
deb http://mirrors.yun-idc.com/ubuntu/ lucid main restricted universe
deb http://mirrors.yun-idc.com/ubuntu/ lucid-security main restricted universe
deb http://mirrors.yun-idc.com/ubuntu/ lucid-updates main restricted universe
EOP
...
wget http://192.168.11.9/tools/xs-tools-6.1.0/Linux/xe-guest-utilities_6.1.0-1033_amd64.deb
